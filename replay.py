...
def replay():
    log_str='37-43-42-41-18-21-29-45-30-22-44-53-61-46-51-60-59-50-47-39-40-34-31-20-11-32-23-52-58-48-26-17-16-10-2-25-33-4-19-9-3-1-0-57-8-62-24-15-56-55-63-13-7-54-5-38-14-6-12-49'
    log=[int(x) for x in log_str.split('-')]
    idx=0
    
    me=1
    B=Board(8)
    while not B.done:
        print(log[idx]%8,log[idx]//8)
        B.Put(log[idx]%8,log[idx]//8)
        idx+=1
        B.Show()
